...
@Component({
  ...
  template: `
    @if (alert(); as a) {
      ...
      >
        ...
        <p class="msg" [id]="'alert-body-' + a.id">{{ a.body }}</p>
  ...
  styles: `
    ...
    /* colour stated rather than inherited: the previous class name picked up a stray
       colour from outside the component, and the line explaining what survived a failed
       write is the last place to leave anything ambiguous */
    .msg {
