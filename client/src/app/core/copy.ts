...
export const COPY = {
  ...
  lead: {
    ...
    files: {
      ...
      add: 'הוסף קובץ',
      adding: 'מעלה…',
      drop: 'גררו קבצים לכאן או לחצו לבחירה',
      dropActive: 'שחררו כדי להוסיף את הקבצים',
      uploadedTitle: 'קבצים שהועלו',
      pendingTitle: 'ממתינים לשמירת הליד',
      ...
      openBlocked: 'הדפדפן חסם את פתיחת הקובץ. אפשר לאפשר חלונות קופצים ולנסות שוב.',
